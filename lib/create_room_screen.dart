...
class _CreateRoomScreenState extends State<CreateRoomScreen> {
  ...
  void createRoom()
  {
    if(_nameController.text.isEmpty &&
        ...
        _roomSizeValue==null)
      {
        print("Eroor while Creating Room, plz fill required details");
      }
        ...
        _roomSizeValue!=null) {
         ...
         Navigator.of(context).push(
             MaterialPageRoute(builder:(context)=> PaintScreen(data: data, screenFrom:  'createRoom')));
      }
    else{
   print(_maxRoundsValue!=null);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          const Text("Create Room",style: TextStyle(color: Colors.black,fontSize: 30),),
